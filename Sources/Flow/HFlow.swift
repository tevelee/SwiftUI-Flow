...
public struct HFlow<Content: View>: View {
    ...
    public init(alignment: VerticalAlignment = .center,
        ...
        layout = _FlowLayout(axis: .horizontal, itemSpacing: itemSpacing, lineSpacing: rowSpacing) { dimensions in
    ...
    public init(alignment: VerticalAlignment = .center,
                spacing: CGFloat? = nil,
                @ViewBuilder content contentBuilder: () -> Content) {
        self.init(alignment: alignment, itemSpacing: spacing, rowSpacing: spacing, content: contentBuilder)
    }
...
extension HFlow: Layout where Content == EmptyView {
    ...
    public init(alignment: VerticalAlignment = .center,
                itemSpacing: CGFloat? = nil,
                rowSpacing: CGFloat? = nil) {
        self.init(alignment: alignment, itemSpacing: itemSpacing, rowSpacing: rowSpacing) {
            EmptyView()
        }
    }
