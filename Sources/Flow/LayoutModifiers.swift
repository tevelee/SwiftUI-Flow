...
// NOTE: The line-limit (`maxLines`) and separator (`itemSeparator`/`lineSeparator`) modifiers are
// additive features and now live in their own targets: `maxLines` in `FlowLineLimit`, the separators
// in `FlowSeparators`. They are no longer part of the core `Flow` module — `import FlowLineLimit` or
// `import FlowSeparators` to use them.
